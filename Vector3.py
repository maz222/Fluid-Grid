# https://gist.github.com/davidnuon/3816736
...
class TripleVector:
    ...
    def div_s(self, scalar):
        return TripleVector(self.x / scalar, self.y / scalar, self.z / scalar)
    ...
    def distance_between(self, operand):
        return math.sqrt((self.x - operand.x)**2 + (self.y - operand.y)**2 + (self.z - operand.z)**2)
